...
class Register(QMainWindow):
    def __init__(self):
        ...
        self.btn_eye_p.clicked.connect(self.hiddenOrShow(self.password, self.btn_eye_p))
        self.btn_eye_cp.clicked.connect(self.hiddenOrShow(self.confirm_password, self.btn_eye_cp))
