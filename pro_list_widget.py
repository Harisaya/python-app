...
class ProductListWidget(QWidget): #ds san pham
    ...
    def setup_ui(self):
        ...
        self.grid_layout.setSpacing(20)  # Space between cards (increased for better spacing)
    ...
    def create_product_cards(self):
        ...
        spacing = 20  # Space between cards (increased for better spacing)
        margin = 20  # Margin around the grid (increased for better spacing)
